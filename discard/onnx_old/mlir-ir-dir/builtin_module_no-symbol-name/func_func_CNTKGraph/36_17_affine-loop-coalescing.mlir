...
func.func @CNTKGraph(%arg0: memref<1x1x28x28xf32, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x10xf32>) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%19)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%28)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%35)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%42)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%49)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%56)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%63)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%68)) {
  ...
  affine.parallel (%arg2) = (0) to (symbol(%71)) {

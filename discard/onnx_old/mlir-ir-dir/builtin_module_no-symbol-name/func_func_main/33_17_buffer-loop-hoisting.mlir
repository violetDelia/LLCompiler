...
func.func @main(%arg0: memref<1x1x28x28xf32, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x10xf32>) {
  ...
  scf.for %arg2 = %c0 to %c1568 step %c1 {
    %6 = arith.remui %arg2, %c8 : index
    %7 = arith.divui %arg2, %c8 : index
    %8 = arith.remui %7, %c14 : index
    %9 = arith.divui %arg2, %c8 : index
  ...
  scf.parallel (%arg2) = (%c0) to (%c2592) step (%c1) {
    %6 = arith.remui %arg2, %c8 : index
    %7 = arith.divui %arg2, %c8 : index
  ...
  scf.for %arg2 = %c0 to %c256 step %c1 {
    %6 = arith.remui %arg2, %c4 : index
    %7 = arith.divui %arg2, %c4 : index
    %8 = arith.remui %7, %c4 : index
    %9 = arith.divui %arg2, %c4 : index
    ...
    scf.for %arg3 = %c0 to %c9 step %c1 {
      ...
      scf.for %arg4 = %c0 to %c200 step %c1 {
        %24 = arith.remui %arg4, %c8 : index
        %25 = arith.divui %arg4, %c8 : index
        %26 = arith.remui %25, %c5 : index
        %27 = arith.divui %arg4, %c8 : index
        %28 = arith.divui %27, %c5 : index
        %29 = arith.divui %arg2, %c4 : index
        %30 = arith.muli %29, %c3 : index
        %31 = arith.divui %arg2, %c4 : index
        %32 = arith.divui %31, %c4 : index
        %33 = arith.muli %32, %c-12 : index
        %34 = arith.addi %30, %33 : index
        %35 = arith.divui %arg3, %c3 : index
        %36 = arith.addi %34, %35 : index
        %37 = arith.divui %arg4, %c8 : index
        %38 = arith.divui %37, %c5 : index
        %39 = arith.addi %36, %38 : index
        %40 = arith.muli %arg2, %c3 : index
        %41 = arith.addi %40, %arg3 : index
        %42 = arith.divui %arg2, %c4 : index
        %43 = arith.muli %42, %c-12 : index
        %44 = arith.addi %41, %43 : index
        %45 = arith.divui %arg3, %c3 : index
        %46 = arith.muli %45, %c-3 : index
        %47 = arith.addi %44, %46 : index
        %48 = arith.divui %arg4, %c8 : index
        %49 = arith.addi %47, %48 : index
        %50 = arith.divui %arg4, %c8 : index
  ...
  scf.parallel (%arg2) = (%c0) to (%c10) step (%c1) {
    memref.store %cst_0, %alloc_11[%c0, %c0, %arg2] : memref<1x1x10xf32>
    scf.for %arg3 = %c0 to %c256 step %c1 {
      %6 = memref.load %expand_shape_10[%c0, %c0, %arg3] : memref<1x1x256xf32>
      %7 = memref.load %4[%c0, %arg3, %arg2] : memref<1x256x10xf32>
      %8 = memref.load %alloc_11[%c0, %c0, %arg2] : memref<1x1x10xf32>
      %9 = arith.mulf %6, %7 : f32
      %10 = arith.addf %8, %9 : f32
      memref.store %10, %alloc_11[%c0, %c0, %arg2] : memref<1x1x10xf32>
    }
    scf.reduce 
  }
  ...
  scf.parallel (%arg2) = (%c0) to (%c10) step (%c1) {
    %6 = memref.load %collapse_shape_12[%c0, %arg2] : memref<1x10xf32>
    %7 = memref.load %5[%c0, %arg2] : memref<1x10xf32>
    %8 = arith.addf %6, %7 : f32
    memref.store %8, %alloc_13[%c0, %arg2] : memref<1x10xf32>
    scf.reduce 
  }

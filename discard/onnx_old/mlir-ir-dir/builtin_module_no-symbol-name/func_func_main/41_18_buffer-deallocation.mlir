...
func.func @main(%arg0: memref<1x1x28x28xf32, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x10xf32>) {
  ...
  scf.for %arg2 = %c0 to %c1568 step %c1 {
    ...
    scf.for %arg3 = %c0 to %c4 step %c1 {
      ...
      scf.for %arg4 = %c0 to %c25 step %c1 {
        %20 = arith.remui %arg4, %c5 : index
        %21 = arith.divui %arg4, %c5 : index
        %22 = arith.muli %9, %c2 : index
        %23 = arith.divui %arg3, %c2 : index
        %24 = arith.addi %22, %23 : index
        %25 = arith.addi %24, %21 : index
        %26 = arith.addi %arg4, %arg3 : index
  ...
  scf.for %arg2 = %c0 to %c256 step %c1 {
    ...
    scf.for %arg3 = %c0 to %c9 step %c1 {
      ...
      scf.for %arg4 = %c0 to %c200 step %c1 {
        %21 = arith.remui %arg4, %c8 : index
        %22 = arith.divui %arg4, %c8 : index
        ...
        %28 = arith.divui %arg3, %c3 : index
        %29 = arith.addi %27, %28 : index
        %30 = arith.addi %29, %24 : index
        %31 = arith.muli %arg2, %c3 : index
  ...
  scf.parallel (%arg2) = (%c0) to (%c10) step (%c1) {
    memref.store %cst_0, %alloc_10[%c0, %c0, %arg2] : memref<1x1x10xf32>
    scf.for %arg3 = %c0 to %c256 step %c1 {
      %6 = affine.apply affine_map<(d0) -> (d0 floordiv 16)>(%arg3)
      %7 = affine.apply affine_map<(d0) -> ((d0 mod 16) floordiv 4)>(%arg3)
      %8 = affine.apply affine_map<(d0) -> (d0 mod 4)>(%arg3)
      %9 = memref.load %alloc_9[%c0, %6, %7, %8] : memref<1x16x4x4xf32>
      %10 = memref.load %4[%c0, %arg3, %arg2] : memref<1x256x10xf32>
      %11 = memref.load %alloc_10[%c0, %c0, %arg2] : memref<1x1x10xf32>
      %12 = arith.mulf %9, %10 : f32
      %13 = arith.addf %11, %12 : f32
      memref.store %13, %alloc_10[%c0, %c0, %arg2] : memref<1x1x10xf32>
    }
    scf.reduce 
  }
  ...
  scf.parallel (%arg2) = (%c0) to (%c10) step (%c1) {
    %6 = memref.load %alloc_10[%c0, %c0, %arg2] : memref<1x1x10xf32>
    %7 = memref.load %5[%c0, %arg2] : memref<1x10xf32>
    %8 = arith.addf %6, %7 : f32
    memref.store %8, %alloc_11[%c0, %arg2] : memref<1x10xf32>
    scf.reduce 
  }

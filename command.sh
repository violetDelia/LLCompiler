...
#llc-opt
C:\coding\LLCompiler\build\tools\llc-opt\llc-opt.exe --dump-pass-pipeline -o=C:\coding\LLCompiler\opt_out.mlir --log-lever=debug  --log-root=C:\coding\LLCompiler\log --mlir-print-ir-tree-dir=C:\coding\LLCompiler\mlir-ir-dir --mlir-print-ir-after-all -common-pipeline C:\coding\LLCompiler\test\model_ir\mnist-12.mlir 

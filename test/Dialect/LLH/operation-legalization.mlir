...
func.func @broadcast_to(%arg0: tensor<?x?xf32> {func.input_symbol_0 = "s0", func.input_symbol_1 = "s1"}) -> tensor<?x?x?xf32> attributes {entrance} {
    ...
    // CHECK: llh.reshape
    %4 = "llh.reshape"(%arg0, %1, %2, %3) : (tensor<?x?xf32>, i64, i64, i64) -> tensor<1x?x?xf32>
    // CHECK: llh.reshape
    ...
    %5 = "llh.broadcast_to"(%arg0, %1, %2, %3) <{cast_dims = array<i64: 1, 2>}> : (tensor<?x?xf32>, i64, i64, i64) -> tensor<1x?x?xf32>
    %6 = "llh.add"(%5, %4) : (tensor<1x?x?xf32>, tensor<1x?x?xf32>) -> tensor<1x?x?xf32>
    // CHECK: llh.reshape
    %7 = "llh.reshape"(%arg0, %2, %1, %3) : (tensor<?x?xf32>, i64, i64, i64) -> tensor<?x1x?xf32>
    // CHECK: llh.reshape
    // CHECK-SAME: tensor<1x?x?xf32>
    // CHECK: llh.broadcast_to
